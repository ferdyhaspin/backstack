...
/**
 * Created by ferdyhaspin on 2020-02-20.
 */
public class FragmentUtil {

    public final static String TAG_NAME_FRAGMENT = "ACTIVITY_FRAGMENT";

    public final static String FRAGMENT_ONE = "FRAGMENT_ONE";
    public final static String FRAGMENT_TWO = "FRAGMENT_TWO";
    public final static String FRAGMENT_THREE = "FRAGMENT_THREE";
